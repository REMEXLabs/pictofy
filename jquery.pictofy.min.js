 ...
 */
!function(t){"use strict";function e(n,o){n.contents().each(function(n,r){var s=t(r);if(3===s.context.nodeType){var a=s.text(),i=a.split(/([^a-zA-Z\x7f-\xff])/),c=i.map(function(t){return/[a-zA-Z\x7f-\xff]+/.test(t)?'<span class="'+o["class"]+'">'+t+"</span>":t});s.replaceWith(c.join(""))}else e(s.not("."+o["class"]),o)})}function n(e,n,s){r(e,s).done(function(r,a){var i=n.tooltipster("content");t(i).append(o(e,r.rating,s))}).fail(function(t,e,n){console.log(e),console.log(n)})}function o(e,n,o){for(var r=t("<div>").addClass("picto-stars").append(),s=function(n){return function(){r.text("Thanks."),t.ajax({url:o.getRatingUrl(e),method:"POST",data:{rating:n},crossDomain:!0,xhrFields:{withCredentials:!0}})}},a=1;a<=5;a++){var i=t("<span>").addClass("picto-stars__star").toggleClass("picto-stars__star--empty",a>n);i.click(s(a)),r.append(i)}return r}function r(e,n){return t.ajax({url:n.getRatingUrl(e),crossDomain:!0,xhrFields:{withCredentials:!0}})}t.fn.pictofy=function(o){var r=t.extend({},t.fn.pictofy.defaults,o);e(this,r);var s=t.res(r.resUrl);return t("."+r["class"]).each(function(e,o){var a=o.innerHTML.toLowerCase().trim(),i=void 0===typeof AS_picsupport?r.lang:AS_picsupport.language||r.lang;s.queries().addQuery().addProp("http://openurc.org/ns/res#type","http://openurc.org/restypes#pictogram").addPropWithDescs("http://purl.org/dc/elements/1.1/title",a).addDesc("lang",i).complete().complete().send().done(function(e){if(e.firstResponse().numberOfResources()>0){var s=e.getVeryFirstGlobalAt();s=s.replace("http://","//");var a=e.firstResponse().firstResource().props.find(function(t){return"http://openurc.org/ns/res#name"===t.name}).value;t(o).attr("data-picto-src",s),t(o).attr("data-picto-name",a),t(o).tooltipster({updateAnimation:null,trigger:"click",theme:"tooltipster-picto",onlyOne:!0,interactive:!0,content:r.preContent,functionReady:function(e){var o=t("<div>").addClass("picto-container");return o.append(t("<img>").attr("src",s)),e.tooltipster("content",o),n(a,e,r),!0}})}}).fail(function(t){console.log(t.error),console.log(t.status)})}),this},t.fn.pictofy.destroy=function(e){var n=t.extend({},t.fn.pictofy.defaults,e);t("."+n["class"]+"[data-picto-src]").tooltipster("destroy"),t("."+n["class"]).each(function(e,n){t(n).replaceWith(t(n).html())})},t.fn.pictofy.defaults={resUrl:"https://res.openurc.org/",getRatingUrl:function(t){return"https://picsupport.gpii.eu/rating/"+encodeURIComponent(t)},lang:"en","class":"picto-tooltip",preContent:t('<div style="height:200px;width:200px;">&nbsp;</div>'),failContent:":("}}(jQuery);